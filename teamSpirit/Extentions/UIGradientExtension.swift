...
public extension UIView {
    ...
    public func addGradientWithDirection(_ direction: GradientDirection, colors: [UIColor], cornerRadius: CGFloat = 0, locations: [Double]? = nil) {
        let gradientLayer = UIGradientLayer(direction: direction, colors: colors, cornerRadius: cornerRadius, locations: locations)
        self.addGradient(gradientLayer)
    }
    
    public func addGradient(_ gradientLayer: UIGradientLayer, cornerRadius: CGFloat = 0) {
...
public extension UIColor {
    ...
    public static func fromGradient(_ gradient: UIGradientLayer, frame: CGRect, cornerRadius: CGFloat = 0) -> UIColor? {
    ...
    public static func fromGradientWithDirection(_ direction: GradientDirection, frame: CGRect, colors: [UIColor], cornerRadius: CGFloat = 0, locations: [Double]? = nil) -> UIColor? {
        let gradient = UIGradientLayer(direction: direction, colors: colors, cornerRadius: cornerRadius, locations: locations)
...
public extension UIImage {
    ...
    public static func fromGradient(_ gradient: UIGradientLayer, frame: CGRect, cornerRadius: CGFloat = 0) -> UIImage? {
