...
func setUPView(){
    ...
    NSLayoutConstraint.activate([
        logoImg.topAnchor.constraint(equalTo: mainView.topAnchor, constant: 30),
    ...
    NSLayoutConstraint.activate([
        titleLable.topAnchor.constraint(equalTo: logoImg.bottomAnchor, constant: 20),
